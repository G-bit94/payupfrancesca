    ...
    <div class="row">
        ...
        <div class="col">
            <p class="lead text-start fs-6">
                ...
                and
                dry, without a dime to show for my hard work over a period more than 3 months.<br><br>
...
<div class="container" id="francesca">
    ...
    <div class="row">
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">And who's Francesca? <span class="text-body-secondary">Well,
                    where do I even start?</span></h2>
    ...
    <div class="row g-5">
        <div class="col-md-8">
            <h3 class="py-3 my-3 fst-italic border-bottom">
                <i class="bi bi-quote display-6" style="display: inline-block; transform: translateY(-10px);"></i>It's
                now clear as day
                she
            ...
            <article class="blog-post">
                ...
                <p class="lead fs-6">I stumbled upon this subreddit called r/SlaveLabour in April 2022,
                    a
                ...
                <hr>
                <p class="lead fs-6">After some brief chat on Reddit and later WhatsApp, Francesca and I agreed upon the
                    scope
                    of
                ...
                <h2>The Work</h2>
                <p class="lead fs-6">Throughout the three months, I poured my heart and soul into the work, ensuring
                    that
                    every
                ...
                <p class="lead fs-6">However, as the work (Yupvoted alongside a few other projects I'd picked up
                ...
                <h3>The Betrayal</h3>
                <p class="lead fs-6">Days turned into weeks and weeks turned into months as I found myself living on a
                    prayer,
                ...
                <p class="lead fs-6">The radio silence and total disregard for my efforts left me feeling betrayed and
                    taken
                    for a
                    ride.</p>
                <ul>
                ...
                <p class="lead fs-6">As the months passed, my frustration and disappointment grew. I had dedicated a
                    significant
            ...
            <article class="blog-post">
                ...
                <p class="lead fs-6">As the situation with Francesca dragged on, I sent her a strongly worded email,
                    expressing my
                ...
                <p class="lead fs-6">To my surprise, I received a response from Stephanie, Francesca's cousin (or so she
                    claimed),
                ...
                <p class="lead fs-6">It was curious that Stephanie appeared to distort my communication, implying I had
                    merely
                ...
                <p class="lead fs-6">And just like Francesca, Stephanie's communication abruptly ceased, leaving me in
                    the
                    lurch
                    once more.</p>
                <p class="lead fs-6">In a last-ditch attempt to get things sorted out, I finally decided to reach out to
                    Colin,
                ...
                <p class="lead fs-6">While I knew it was a long shot, I hoped that involving Colin might finally lead to
                    a
                    breakthrough in this nightmare.</p>

                <p class="lead fs-6">As I continue waiting for a response from Colin, almost an year now (I don't expect a response anyway), I can't
                    help
                    but
            ...
            <article class="blog-post">
                ...
                <p class="lead fs-6">It has now been over 2 years since the money was due of the project, and I am still
                    waiting
                    for the payment that I rightfully earned. Unsurprisingly, the financial impact of this scam has been
                    ...
                    months.</p>
                <p class="lead fs-6">Looking back, it's plain as day that Francesca's intentions were never to engage in
                    a
                    fair
                ...
                <p class="lead fs-6">This whole experience has been a rude awakening to the risks and challenges
                    freelancers
                    face
                ...
                <p class="lead fs-6">As I continue to navigate this difficult situation, I remain determined to seek
                    justice
                    and
        ...
        <div class="col-md-4">
            <div class="position-sticky" style="top: 2rem;">
                <div class="p-4 mb-3 bg-body-tertiary rounded">
                    ...
                    <p class="mb-0 lead fs-6">I don't purport to speak on behalf of other people Francesca has
                        potentially
...
<div class="container" id="evidence">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <p class="lead fs-6">Some representative placeholder content for the three columns of text below the
                carousel.
                This is
                the first column.</p>
        ...
        <div class="col-lg-4">
            ...
            <p class="lead fs-6">Another exciting bit of representative placeholder content. This time, we've moved on
                to the
                second column.</p>
            <p><a class="btn btn-secondary" href="#">View details »</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            ...
            <p class="lead fs-6">And lastly this, the third column of representative placeholder content.</p>
            <p><a class="btn btn-secondary" href="#">View details »</a></p>
        </div><!-- /.col-lg-4 -->
    </div><!-- /.row -->
</div>
        ...
        <div class="col-md-10 mx-auto col-lg-5">
            <form id="sendMessageForm" class="p-3 row border rounded-3 bg-light g-3 needs-validation was-validated" novalidate="">
                ...
                <div class="col-md-6">
                    ...
                    <div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div>
                    <div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div>
                <div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div><div style="position: relative !important; height: 0px !important; width: 0px !important; float: left !important;" data-lastpass-icon-root=""></div></div>
...
<div class="container">
    ...
    <div class="row featurette">
        <div class="col-md-7">
            <h2 class="featurette-heading fw-normal lh-1">Think we can collab? <span class="text-body-secondary">Drop me
                    a line.</span></h2>
